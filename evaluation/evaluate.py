...
class Ui_Evaluation(object):
    ...
    def messagebox(self, title, message):
        ...
        icon_path = os.path.join(os.getcwd(), "Icons", "message.png")  # Updated path
        mess.setWindowIcon(QtGui.QIcon(icon_path))
        font = QtGui.QFont()
    ...
    def setupUi(self, Evaluation):
        ...
        icon_path = os.path.join(os.getcwd(), "Icons", "cricket.png")  # Updated path
        Evaluation.setWindowIcon(QtGui.QIcon(icon_path))
